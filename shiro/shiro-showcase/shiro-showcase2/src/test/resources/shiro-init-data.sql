...
insert into users(username, password, password_salt) values('aaron', '123', null);
insert into user_roles(username, role_name) values('aaron', 'role1');
insert into user_roles(username, role_name) values('aaron', 'role2');
