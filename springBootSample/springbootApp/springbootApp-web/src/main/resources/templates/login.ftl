...
<head>
	...
	<link rel="stylesheet" href="/js/libs/validator-0.7.3/jquery.validator.css">
	<link rel="stylesheet" href="/css/sweetalert/sweetalert.css">
	<script src="/js/libs/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/js/libs/validator-0.7.3/jquery.validator.js"></script>
	<script type="text/javascript" src="/js/libs/validator-0.7.3/local/zh_CN.js"></script>
	<script type="text/javascript" src="/js/libs/host.js"></script>
