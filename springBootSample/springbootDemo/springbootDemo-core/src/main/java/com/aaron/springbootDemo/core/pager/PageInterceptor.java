...
import com.allchips.common.base.page.Pagination;
import com.allchips.common.base.parser.CountSqlParser;
...
public class PageInterceptor implements Interceptor {
	...
	private String getMysqlPageSql(Pagination page, StringBuffer sqlBuffer) {
		...
		int offset = (page.getCurrentPageNo() - 1) * page.getPageSize();
	...
	private String getOraclePageSql(Pagination page, StringBuffer sqlBuffer) {
		...
		int offset = (page.getCurrentPageNo() - 1) * page.getPageSize() + 1;
