...
import com.allchips.common.base.page.PageInterceptor;
import com.allchips.common.db.DaoTimeConsumingMonitor;
...
/**
 * Created by Aaron.Qiu on 2020-10-29.
 */
@Configuration
    ...
    */
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) {
        ...
        try {
            ...
            //设置别名打包有问题
            //sqlSessionFactory.setTypeAliasesPackage("com.allchips.product.api.bean");
            PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
            Resource[] classPathResources = resolver.getResources("classpath*:com/aaron/springbootDemo/dao/**/*.xml");
